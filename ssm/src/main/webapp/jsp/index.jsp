...
<body>
    <div class="header">
        ...
        <ul class="inline">
            <li>
                <img src="${pageContext.request.contextPath}/images/32/avatar5.png" style="height: 32px;width: 32px" />&nbsp;&nbsp;欢迎您${usern},
            </li>
            <li class="dropdown">
    ...
    <div class="container-fluid content">
        <div class="row-fluid">
            ...
            <div class="span10 content-right">
                <iframe src="${pageContext.request.contextPath}/cust/list" class="iframe"></iframe>
            </div>
        </div>
    </div>
